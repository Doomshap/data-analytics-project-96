...
sessions.visitor_id, sessions.visit_date, leads.created_at, leads.status_id, amount, lead_id, closing_reason, medium, source, campaign 
from sessions 
left join leads 
...
group by 1,2,3,4),
 ...
 tab2 as
(select source, medium, campaign, cast(visit_date as date) as visit_date,
